...
//                             Cancel
//                         </Button>
//                     <Button onClick={handleImageChange} variant="contained" color="primary">
//                         Add to Post
//                     </Button>
//                     </DialogActions>
//                 </DialogActions>
...
const QI = ({ onAiClose }) => {
    ...
    return (
        <>
            <Dialog
                fullWidth
                maxWidth="md" // Adjusted to decrease the width of the dialog
                open={true}
                onClose={onAiClose}
                PaperProps={{
                    component: 'form',
                    ...
                    <Grid item xs={12} md={6} sx={{ borderRight: '0.5px solid #ccc', paddingRight: '15px' }}>
                        ...
                        <DialogContent sx={{ marginTop: '10px' }}>
                            <TextField
                                ...
                                label="Enter text here"
                                type="text"
                                variant="outlined" // Used "outlined" for a more distinct input field
                                value={inputText}
                                fullWidth
                                sx={{ marginBottom: '20px' }}
                                onChange={(e) => setInputText(e.target.value)}

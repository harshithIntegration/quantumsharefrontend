...
//                         <Grid
//         item
//         xs={false}  // Hide the video on extra-small screens
//         sm={false}  // Hide the video on small screens
//     md={7}     // Show the video starting from medium screens and up
//         sx={{
...
//             <IconButton
//                 onClick={toggleMute}
//                 style={{ position: 'absolute', top: '10px', right: '5px', color: '#BA343B' }}
//             >
//                 {isMuted ? <VolumeOffIcon /> : <VolumeUpIcon />}
//             </IconButton>
//         </Box>
//     </Grid>
//                         <Grid item xs={12} sm={12} md={7} component={Paper} square>
//                             <Box
//                                 sx={{ my: -0.5, mx: 5, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
//                                 <CloseOutlinedIcon style={{ position: 'absolute', top: 0, right: 0,fontSize: 30, color: '#ba343b', cursor: 'pointer',}}onClick={handleCloseSignUp} />
...
//                                             onChange={handleChange} error={!!errors.firstName} helperText={errors.firstName} InputProps={{sx: { height: '50px', padding: '0 10px'},}} InputLabelProps={{sx: {fontSize: '14px',}, }} />
//                                         </Grid>
//                                         <Grid item xs={10} sm={5}>
//                                             <TextField required fullWidth id="lastName" label="Last Name" name="lastName" autoComplete="family-name" value={lastName} onChange={handleChange} error={!!errors.lastName} helperText={errors.lastName} InputProps={{sx: { height: '50px', padding: '0 10px',},}}InputLabelProps={{ sx: {fontSize: '14px', },}} />
//                                         </Grid>      
//                                         <Grid item xs={10}>
//                                             <TextField required fullWidth id="email" label="Email Address" name="email" autoComplete="email" value={email} onChange={handleChange} error={!!errors.email} helperText={errors.email} InputProps={{sx: {height: '50px',padding: '0 10px',}}}InputLabelProps={{sx: {fontSize: '14px'},}} />        
//                                         </Grid>
//                                         <Grid item xs={10}>
//                                             <TextField required fullWidth name="phoneNo" label="Phone Number" id="phoneNo" value={phoneNo} onChange={handleChange} error={!!errors.phoneNo} helperText={errors.phoneNo} InputProps={{sx: {height: '50px',padding: '0 10px',},}}InputLabelProps={{sx: {fontSize: '14px',},}} />
//                                         </Grid>
//                                         <Grid item xs={10}>
//                                             <TextField required fullWidth name="password" label="Password" type={passwordVisible ? 'text' : 'password'} id="password" autoComplete="new-password" value={password} onChange={handleChange} error={!!errors.password} helperText={errors.password} InputProps={{sx: {height: '50px',padding: '0 10px',},}}InputLabelProps={{sx: {fontSize: '14px',},}}/>
//                                         </Grid>
//                                         <Grid item xs={10}>
//                                             <TextField required fullWidth name="confirm_password" label="Confirm Password" type={confirmPasswordVisible ? 'text' : 'password'} id="confirm_password" autoComplete="new-password" value={confirm_password} onChange={handleChange} error={!!errors.confirm_password} helperText={errors.confirm_password} InputProps={{sx: {height: '50px',padding: '0 10px',},}}InputLabelProps={{sx: {fontSize: '14px',},}} />
//                                         </Grid>
//                                         <Grid item xs={10}>
//                                             <TextField fullWidth name="company" label="Company Name (Optional)" id="company" value={company} onChange={handleChange} InputProps={{sx: { height: '50px', padding: '0 10px',},}}InputLabelProps={{sx: { fontSize: '14px',},}} />        
//                                         </Grid>
//                                         <Grid item xs={10}>
//                                             <Button type="submit" fullWidth variant="contained"
//                                                 sx={{mt: 1, mb: 2, height: '50px', fontSize: '18px', bgcolor: '#ba343b','&:hover': { bgcolor: '#9e2b31' },}}>Sign Up   
//                                             </Button>
//                                         </Grid>
//                                     </Grid>
//                                     <Box sx={{ width: 'fit-content', margin: '0 auto', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
//                                         <GoogleLogin onSuccess={handleGoogleLoginSuccess} onError={() => {console.log('Login Failed');}}  style={{ width: '100%', borderRadius: '10px', overflow: 'hidden' }}/>
//                                     </Box>
...
//                     </Typography>
//                     <DialogTitle sx={{ m: 0, p: 2, color: '#ba343b', fontSize: '20px', textAlign: 'center' }}>Set your Password </DialogTitle>
...
//                                     helperText={errors.confirm_password}
//                                     InputProps={{sx: { height: '50px', padding: '0 10px',}, endAdornment: (<EndAdornment visible={confirmPasswordVisible} setVisible={handleToggleConfirmPasswordVisibility}/>)}}InputLabelProps={{sx: {fontSize: '14px',},}}/>       
//                             </Grid>
//                             <Grid item xs={11}>
//                                 <Button fullWidth variant="contained" onClick={handleGoogleSubmit} sx={{ bgcolor: '#ba343b', color: 'white', height: 50, fontSize: 16, '&:hover': { bgcolor: '#9e2b31', }, mt: 15, '&:disabled': { bgcolor: '#e0e0e0', color: '#a0a0a0', } }}disabled={!password || !confirm_password || loading}>
